...
tth = h5read("Z:\PAL_XFEL_2409\rawData\I3_MeOH_00002_DIR\eh1rayMXAI_tth\001_001_001.h5","/1725167840.1521745_5784");


folder = "Z:\PAL_XFEL_2409\rawData\I3_MeOH_00002_DIR\eh1rayMXAI_int";
...
I = zeros(size(tth,1),size(h5.Datasets,1));
...
for i = 1 : 20
    figure; hold on;
    title(sprintf("2\\theta=%f, \\sigma=%f",tth(20*i),I_std(20*i)));
    histogram(I(20*i,:),100);
    xline(I_mean(20*i),'r:','LineWidth',3);
    hold off;
end
figure;
surf(tth,1:1:500,I');

function [best_par_struct, V_fit, save_struct] = fit_rsv_v2(t, V, num_tau, num_start)
...
% typ(i1+2) = 1;
% 
% lb(i1+3)  = log10(0.1e-9);
% ub(i1+3)  = log10(1e-9);
% typ(i1+3) = 1;

lb(i1+1:i2-1)  = log10(1.5e-13);
ub(i1+1:i2-1)  = log10(3.16e-9);
typ(i1+1:i2-1) = 1;
...
% --- Draw figures ---
t_dense = linspace(t(1), t(end), 10000);
t_dense = t_dense(:);
